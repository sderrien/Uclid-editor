...
public class UclidSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == UclidPackage.eINSTANCE)
			...
			case UclidPackage.DEFINE_DECL_RULE:
				sequence_DefineDeclRule(context, (DefineDeclRule) semanticObject); 
				return; 
			...
			case UclidPackage.ID_LIST_RULE:
				if (rule == grammarAccess.getIdListRuleRule()) {
					sequence_IdListRule(context, (IdListRule) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getInputsDeclRuleRule()) {
					sequence_IdListRule_InputsDeclRule(context, (IdListRule) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getDeclRuleRule()) {
					sequence_IdListRule_InputsDeclRule_OutputsDeclRule_SharedVarsDeclRule(context, (IdListRule) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getOutputsDeclRuleRule()) {
					sequence_IdListRule_OutputsDeclRule(context, (IdListRule) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getSharedVarsDeclRuleRule()) {
					sequence_IdListRule_SharedVarsDeclRule(context, (IdListRule) semanticObject); 
					return; 
				}
				else break;
			case UclidPackage.ID_TYPE_LIST_RULE:
				sequence_IdTypeListRule(context, (IdTypeListRule) semanticObject); 
				return; 
			...
			case UclidPackage.INVARIANT_CLAUSE_RULE:
				sequence_InvariantClauseRule(context, (InvariantClauseRule) semanticObject); 
				return; 
			...
			case UclidPackage.SPEC_DECL_RULE:
				sequence_SpecDeclRule(context, (SpecDeclRule) semanticObject); 
				return; 
			...
			case UclidPackage.SYNONYM_TYPE_RULE:
				sequence_SynonymTypeRule(context, (SynonymTypeRule) semanticObject); 
				return; 
			...
			case UclidPackage.VAR_REF:
				if (rule == grammarAccess.getLhsVarRefRule()) {
					sequence_LhsVarRef(context, (VarRef) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getRHSVarRefRule()
						|| rule == grammarAccess.getE13RuleRule()) {
					sequence_RHSVarRef(context, (VarRef) semanticObject); 
					return; 
				}
				else break;
	 ...
	 *
	 * Constraint:
	 *     (lhs+=Lhs lhs+=Lhs* exprs+=ExprRule exprs+=ExprRule*)
	 */
	 ...
	 * Constraint:
	 *     (
	 *         ((lhs+=Lhs lhs+=Lhs*)? target=[ProcedureDecl|FQN] exprs+=ExprRule exprs+=ExprRule*) | 
	 *         (target=[ProcedureDecl|FQN] exprs+=ExprRule exprs+=ExprRule*)
	 *     )
	 */
	...
	protected void sequence_ConstDecl(ISerializationContext context, ConstDecl semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UclidPackage.Literals.VAR_DECL__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UclidPackage.Literals.VAR_DECL__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getConstDeclAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     DeclRule returns DefineDeclRule
	 *     DefineDeclRule returns DefineDeclRule
	 *
	 * Constraint:
	 *     (name=ID l=IdTypeListRule? t=TypeRule e=ExprRule)
	 */
	protected void sequence_DefineDeclRule(ISerializationContext context, DefineDeclRule semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     ((pred='forall' | pred='exists') l=IdTypeListRule? a=E1Rule)
	 */
	 ...
	 *
	 * Constraint:
	 *     (iterator=VarDecl lb=INT ub=INT body=BlkStmtRule)
	 */
	protected void sequence_ForLoopRule(ISerializationContext context, ForLoopRule semanticObject) {
		...
		feeder.accept(grammarAccess.getForLoopRuleAccess().getLbINTTerminalRuleCall_5_0(), semanticObject.getLb());
		feeder.accept(grammarAccess.getForLoopRuleAccess().getUbINTTerminalRuleCall_7_0(), semanticObject.getUb());
	 ...
	 *
	 * Constraint:
	 *     (name=ID l=IdTypeListRule? t=TypeRule)
	 */
	...
	/**
	 * Contexts:
	 *     InputsDeclRule returns IdListRule
	 *
	 * Constraint:
	 *     ((name+=ID | (name+=ID l=IdListRule)) t=TypeRule)
	 */
	protected void sequence_IdListRule_InputsDeclRule(ISerializationContext context, IdListRule semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     DeclRule returns IdListRule
	 *
	 * Constraint:
	 *     ((name+=ID | (name+=ID l=IdListRule)) (t=TypeRule | t=TypeRule | t=TypeRule))
	 */
	protected void sequence_IdListRule_InputsDeclRule_OutputsDeclRule_SharedVarsDeclRule(ISerializationContext context, IdListRule semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     OutputsDeclRule returns IdListRule
	 *
	 * Constraint:
	 *     ((name+=ID | (name+=ID l=IdListRule)) t=TypeRule)
	 */
	protected void sequence_IdListRule_OutputsDeclRule(ISerializationContext context, IdListRule semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     SharedVarsDeclRule returns IdListRule
	 *
	 * Constraint:
	 *     ((name+=ID | (name+=ID l=IdListRule)) t=TypeRule)
	 */
	protected void sequence_IdListRule_SharedVarsDeclRule(ISerializationContext context, IdListRule semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     IdTypeListRule returns IdTypeListRule
	 *
	 * Constraint:
	 *     (k+=ID z+=ID* t=TypeRule l=IdTypeListRule?)
	 */
	protected void sequence_IdTypeListRule(ISerializationContext context, IdTypeListRule semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     InvariantClauseRule returns InvariantClauseRule
	 *
	 * Constraint:
	 *     e=ExprRule
	 */
	protected void sequence_InvariantClauseRule(ISerializationContext context, InvariantClauseRule semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UclidPackage.Literals.INVARIANT_CLAUSE_RULE__E) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UclidPackage.Literals.INVARIANT_CLAUSE_RULE__E));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getInvariantClauseRuleAccess().getEExprRuleParserRuleCall_2_0(), semanticObject.getE());
		feeder.finish();
	}
	 ...
	 *     var=[VarDecl|FQN]
	 */
	protected void sequence_LhsVarRef(ISerializationContext context, VarRef semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UclidPackage.Literals.VAR_REF__VAR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UclidPackage.Literals.VAR_REF__VAR));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getLhsVarRefAccess().getVarVarDeclFQNParserRuleCall_0_1(), semanticObject.eGet(UclidPackage.Literals.VAR_REF__VAR, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (target=LhsVarRef (index+=ExprRule index+=ExprRule*)?)
	 */
	...
	protected void sequence_ProcReturnArgRule(ISerializationContext context, ProcReturnArgRule semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UclidPackage.Literals.PROC_RETURN_ARG_RULE__L) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UclidPackage.Literals.PROC_RETURN_ARG_RULE__L));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getProcReturnArgRuleAccess().getLIdTypeListRuleParserRuleCall_2_0(), semanticObject.getL());
		feeder.finish();
	}
	 ...
	 *     E13Rule returns VarRef
	 *
	 * Constraint:
	 *     (var=[VarDecl|FQN] prime='''?)
	 */
	protected void sequence_RHSVarRef(ISerializationContext context, VarRef semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     DeclRule returns SpecDeclRule
	 *     SpecDeclRule returns SpecDeclRule
	 *
	 * Constraint:
	 *     (((prop='property' | prop='invariant') name=ID e=ExprRule) | ((prop='property' | prop='invariant') e=ExprRule))
	 */
	protected void sequence_SpecDeclRule(ISerializationContext context, SpecDeclRule semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     TypeRule returns SynonymTypeRule
	 *     SynonymTypeRule returns SynonymTypeRule
	 *
	 * Constraint:
	 *     decl=[TypeDecl|ID]
	 */
	protected void sequence_SynonymTypeRule(ISerializationContext context, SynonymTypeRule semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, UclidPackage.Literals.SYNONYM_TYPE_RULE__DECL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, UclidPackage.Literals.SYNONYM_TYPE_RULE__DECL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSynonymTypeRuleAccess().getDeclTypeDeclIDTerminalRuleCall_1_0_1(), semanticObject.eGet(UclidPackage.Literals.SYNONYM_TYPE_RULE__DECL, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (c=ExprRule inv+=InvariantClauseRule* stmt=BlkStmtRule)
	 */
