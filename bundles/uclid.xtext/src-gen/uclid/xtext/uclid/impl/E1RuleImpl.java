 ...
 *   <li>{@link uclid.xtext.uclid.impl.E1RuleImpl#getExistential <em>Existential</em>}</li>
...
public class E1RuleImpl extends ExprRuleImpl implements E1Rule
{
  ...
  /**
   * The cached value of the '{@link #getExistential() <em>Existential</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getExistential()
   * @generated
   ...
   * @generated
   */
  public NotificationChain basicSetExistential(EObject newExistential, NotificationChain msgs)
  {
    EObject oldExistential = existential;
    existential = newExistential;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UclidPackage.E1_RULE__EXISTENTIAL, oldExistential, newExistential);
   ...
   */
  @Override
  public void setExistential(EObject newExistential)
  {
    if (newExistential != existential)
    {
      NotificationChain msgs = null;
      if (existential != null)
        msgs = ((InternalEObject)existential).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UclidPackage.E1_RULE__EXISTENTIAL, null, msgs);
      if (newExistential != null)
        msgs = ((InternalEObject)newExistential).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UclidPackage.E1_RULE__EXISTENTIAL, null, msgs);
      msgs = basicSetExistential(newExistential, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UclidPackage.E1_RULE__EXISTENTIAL, newExistential, newExistential));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UclidPackage.E1_RULE__EXISTENTIAL:
        return basicSetExistential(null, msgs);
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case UclidPackage.E1_RULE__PRED:
        ...
        return;
      case UclidPackage.E1_RULE__EXISTENTIAL:
        setExistential((EObject)newValue);
        return;
      case UclidPackage.E1_RULE__A:
