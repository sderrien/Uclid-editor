 ...
 *   <li>{@link uclid.xtext.uclid.impl.AxiomDeclRuleImpl#getH <em>H</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AxiomDeclRuleImpl extends DeclRuleImpl implements AxiomDeclRule
{
   ...
   * @generated
   */
  public NotificationChain basicSetH(ExprRule newH, NotificationChain msgs)
  {
    ExprRule oldH = h;
    h = newH;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UclidPackage.AXIOM_DECL_RULE__H, oldH, newH);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   */
  @Override
  public void setH(ExprRule newH)
  {
    if (newH != h)
    {
      NotificationChain msgs = null;
      if (h != null)
        msgs = ((InternalEObject)h).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UclidPackage.AXIOM_DECL_RULE__H, null, msgs);
      if (newH != null)
        msgs = ((InternalEObject)newH).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UclidPackage.AXIOM_DECL_RULE__H, null, msgs);
      msgs = basicSetH(newH, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UclidPackage.AXIOM_DECL_RULE__H, newH, newH));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case UclidPackage.AXIOM_DECL_RULE__H:
