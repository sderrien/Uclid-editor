...
public class UclidPackageImpl extends EPackageImpl implements UclidPackage
{
   ...
   * @generated
   */
  private EClass typedObjectDeclEClass = null;
   ...
   * @generated
   */
  private EClass invariantRuleEClass = null;
   ...
   */
  @Override
  public EReference getInputsDeclRule_Inputs()
  {
    return (EReference)inputsDeclRuleEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getInputsDeclRule_T()
  {
    return (EReference)inputsDeclRuleEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getOutputsDeclRule_Outputs()
  {
    return (EReference)outputsDeclRuleEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getOutputsDeclRule_T()
  {
    return (EReference)outputsDeclRuleEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EClass getTypedObjectDecl()
  {
    return typedObjectDeclEClass;
  }
   ...
   */
  @Override
  public EAttribute getTypedObjectDecl_Name()
  {
    return (EAttribute)typedObjectDeclEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getFuncDecl_Inputs()
  {
    return (EReference)funcDeclEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getFuncDecl_T()
  {
    return (EReference)funcDeclEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getFuncDecl_E()
  {
    return (EReference)funcDeclEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EReference getSharedVarsDeclRule_Vars()
  {
    return (EReference)sharedVarsDeclRuleEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getSharedVarsDeclRule_T()
  {
    return (EReference)sharedVarsDeclRuleEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getArgList_T()
  {
   ...
   */
  @Override
  public EReference getProcReturnArgRule_Output()
  {
  ...
  {
    return (EReference)specDeclRuleEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EClass getInvariantRule()
  {
    return invariantRuleEClass;
  }
   ...
   */
  @Override
  public EAttribute getCallStatement_Target()
  {
   ...
   */
  @Override
  public EReference getForLoopRule_Lb()
  {
    return (EReference)forLoopRuleEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getForLoopRule_Ub()
  {
    return (EReference)forLoopRuleEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EReference getE1Rule_Existential()
  {
   ...
   */
  @Override
  public EAttribute getE2Rule_Op()
  {
    return (EAttribute)e2RuleEClass.getEStructuralFeatures().get(1);
  }
  ...
  {
    return (EReference)e2RuleEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EAttribute getE3Rule_Op()
  {
    return (EAttribute)e3RuleEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getVarReference_Index()
  {
   ...
   */
  @Override
  public EAttribute getType_Decl()
  {
  ...
  {
    return (EAttribute)idListRuleEClass.getEStructuralFeatures().get(0);
  }
  ...
  {
    return (EReference)idListRuleEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getRecordTypeRule_Type()
  {
    return (EReference)recordTypeRuleEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(inputsDeclRuleEClass, INPUTS_DECL_RULE__INPUTS);
    createEReference(inputsDeclRuleEClass, INPUTS_DECL_RULE__T);

    outputsDeclRuleEClass = createEClass(OUTPUTS_DECL_RULE);
    createEReference(outputsDeclRuleEClass, OUTPUTS_DECL_RULE__OUTPUTS);
    createEReference(outputsDeclRuleEClass, OUTPUTS_DECL_RULE__T);

    typedObjectDeclEClass = createEClass(TYPED_OBJECT_DECL);
    createEAttribute(typedObjectDeclEClass, TYPED_OBJECT_DECL__NAME);
    ...
    createEReference(funcDeclEClass, FUNC_DECL__INPUTS);
    createEReference(funcDeclEClass, FUNC_DECL__T);
    createEReference(funcDeclEClass, FUNC_DECL__E);
    ...
    createEReference(sharedVarsDeclRuleEClass, SHARED_VARS_DECL_RULE__VARS);
    createEReference(sharedVarsDeclRuleEClass, SHARED_VARS_DECL_RULE__T);

    argListEClass = createEClass(ARG_LIST);
    createEReference(argListEClass, ARG_LIST__ARGS);
    createEReference(argListEClass, ARG_LIST__T);

    procReturnArgRuleEClass = createEClass(PROC_RETURN_ARG_RULE);
    createEReference(procReturnArgRuleEClass, PROC_RETURN_ARG_RULE__OUTPUT);
    ...
    invariantRuleEClass = createEClass(INVARIANT_RULE);
    ...
    createEAttribute(callStatementEClass, CALL_STATEMENT__TARGET);
    ...
    createEReference(forLoopRuleEClass, FOR_LOOP_RULE__LB);
    createEReference(forLoopRuleEClass, FOR_LOOP_RULE__UB);
    ...
    createEReference(varReferenceEClass, VAR_REFERENCE__INDEX);

    typeEClass = createEClass(TYPE);
    createEAttribute(typeEClass, TYPE__DECL);
    ...
    createEReference(recordTypeRuleEClass, RECORD_TYPE_RULE__TYPE);
  ...
  public void initializePackageContents()
  {
    ...
    inputDeclEClass.getESuperTypes().add(this.getTypedObjectDecl());
    outputDeclEClass.getESuperTypes().add(this.getTypedObjectDecl());
    varDeclEClass.getESuperTypes().add(this.getTypedObjectDecl());
    funcDeclEClass.getESuperTypes().add(this.getDeclRule());
    funcDeclEClass.getESuperTypes().add(this.getTypedObjectDecl());
    varsDeclRuleEClass.getESuperTypes().add(this.getDeclRule());
    constsDeclRuleEClass.getESuperTypes().add(this.getDeclRule());
    constDeclEClass.getESuperTypes().add(this.getTypedObjectDecl());
    ...
    propertyRuleEClass.getESuperTypes().add(this.getSpecDeclRule());
    invariantRuleEClass.getESuperTypes().add(this.getSpecDeclRule());
    ...
    varReferenceEClass.getESuperTypes().add(this.getE13Rule());
    ...
    functionDeclEClass.getESuperTypes().add(this.getFuncDecl());
    procedureDeclEClass.getESuperTypes().add(this.getFuncDecl());
    ...
    initEReference(getInputsDeclRule_Inputs(), this.getInputDecl(), null, "inputs", null, 0, -1, InputsDeclRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getInputsDeclRule_T(), this.getType(), null, "t", null, 0, 1, InputsDeclRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getOutputsDeclRule_Outputs(), this.getOutputDecl(), null, "outputs", null, 0, -1, OutputsDeclRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOutputsDeclRule_T(), this.getType(), null, "t", null, 0, 1, OutputsDeclRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(typedObjectDeclEClass, TypedObjectDecl.class, "TypedObjectDecl", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getTypedObjectDecl_Name(), ecorePackage.getEString(), "name", null, 0, 1, TypedObjectDecl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getFuncDecl_Inputs(), this.getArgList(), null, "inputs", null, 0, 1, FuncDecl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getFuncDecl_T(), this.getType(), null, "t", null, 0, 1, FuncDecl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getFuncDecl_E(), this.getExprRule(), null, "e", null, 0, 1, FuncDecl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getConstsDeclRule_Constants(), this.getConstDecl(), null, "constants", null, 0, -1, ConstsDeclRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getSharedVarsDeclRule_Vars(), this.getVarDecl(), null, "vars", null, 0, -1, SharedVarsDeclRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSharedVarsDeclRule_T(), this.getType(), null, "t", null, 0, 1, SharedVarsDeclRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(argListEClass, ArgList.class, "ArgList", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getArgList_Args(), this.getVarDecl(), null, "args", null, 0, -1, ArgList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getArgList_T(), this.getType(), null, "t", null, 0, 1, ArgList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getProcReturnArgRule_Output(), this.getArgList(), null, "output", null, 0, 1, ProcReturnArgRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(invariantRuleEClass, InvariantRule.class, "InvariantRule", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEReference(getCallStatement_Lhs(), this.getVarReference(), null, "lhs", null, 0, -1, CallStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getCallStatement_Target(), ecorePackage.getEString(), "target", null, 0, 1, CallStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getForLoopRule_Lb(), this.getConstRule(), null, "lb", null, 0, 1, ForLoopRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getForLoopRule_Ub(), this.getConstRule(), null, "ub", null, 0, 1, ForLoopRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getWhileLoopRule_Inv(), this.getSpecDeclRule(), null, "inv", null, 0, -1, WhileLoopRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getE1Rule_Existential(), ecorePackage.getEObject(), null, "existential", null, 0, 1, E1Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getE2Rule_Op(), ecorePackage.getEString(), "op", null, 0, 1, E2Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getE3Rule_Op(), ecorePackage.getEString(), "op", null, 0, 1, E3Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getVarReference_Index(), this.getExprRule(), null, "index", null, 0, -1, VarReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(typeEClass, Type.class, "Type", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getType_Decl(), ecorePackage.getEString(), "decl", null, 0, 1, Type.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getAssignment_Lhs(), this.getVarReference(), null, "lhs", null, 0, -1, Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRecordTypeRule_Fields(), this.getVarDecl(), null, "fields", null, 0, -1, RecordTypeRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRecordTypeRule_Type(), this.getType(), null, "type", null, 0, 1, RecordTypeRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
