...
public class UclidSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case UclidPackage.TYPED_OBJECT_DECL:
      {
        TypedObjectDecl typedObjectDecl = (TypedObjectDecl)theEObject;
        T result = caseTypedObjectDecl(typedObjectDecl);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case UclidPackage.INPUT_DECL:
      {
        ...
        if (result == null) result = caseTypedObjectDecl(inputDecl);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case UclidPackage.OUTPUT_DECL:
      {
        ...
        if (result == null) result = caseTypedObjectDecl(outputDecl);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case UclidPackage.VAR_DECL:
      {
        ...
        if (result == null) result = caseTypedObjectDecl(varDecl);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case UclidPackage.FUNC_DECL:
      {
        ...
        if (result == null) result = caseDeclRule(funcDecl);
        if (result == null) result = caseTypedObjectDecl(funcDecl);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case UclidPackage.CONST_DECL:
      {
        ...
        if (result == null) result = caseTypedObjectDecl(constDecl);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case UclidPackage.PROPERTY_RULE:
      {
        ...
        if (result == null) result = caseSpecDeclRule(propertyRule);
        if (result == null) result = caseDeclRule(propertyRule);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case UclidPackage.INVARIANT_RULE:
      {
        InvariantRule invariantRule = (InvariantRule)theEObject;
        T result = caseInvariantRule(invariantRule);
        if (result == null) result = caseSpecDeclRule(invariantRule);
        if (result == null) result = caseDeclRule(invariantRule);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case UclidPackage.VAR_REFERENCE:
      {
        ...
        if (result == null) result = caseE13Rule(varReference);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case UclidPackage.FUNCTION_DECL:
      {
        ...
        if (result == null) result = caseFuncDecl(functionDecl);
        if (result == null) result = caseDeclRule(functionDecl);
        if (result == null) result = caseTypedObjectDecl(functionDecl);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case UclidPackage.PROCEDURE_DECL:
      {
        ...
        if (result == null) result = caseFuncDecl(procedureDecl);
        if (result == null) result = caseDeclRule(procedureDecl);
        if (result == null) result = caseTypedObjectDecl(procedureDecl);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case UclidPackage.ENUM_VALUE:
      {
        ...
        if (result == null) result = caseTypedObjectDecl(enumValue);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Typed Object Decl</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Typed Object Decl</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseTypedObjectDecl(TypedObjectDecl object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Invariant Rule</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Invariant Rule</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseInvariantRule(InvariantRule object)
  {
    return null;
  }
