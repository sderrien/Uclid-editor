 ...
 * </p>
 * <ul>
 *   <li>{@link uclid.xtext.uclid.SpecDeclRule#getProp <em>Prop</em>}</li>
...
public interface SpecDeclRule extends DeclRule
{
   ...
   * @see #setProp(String)
   * @see uclid.xtext.uclid.UclidPackage#getSpecDeclRule_Prop()
   * @model
   * @generated
   */
  String getProp();
  ...
  /**
   * Sets the value of the '{@link uclid.xtext.uclid.SpecDeclRule#getProp <em>Prop</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
