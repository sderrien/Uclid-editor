...
@after {
	...
	(
		...
		{
			$current = $this_IdListRule_1.current;
			afterParserOrEnumRuleCall();
		}
		otherlv_2=':'
		{
...
entryRuleLhsVarRef returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getLhsVarRefRule()); }
	iv_ruleLhsVarRef=ruleLhsVarRef
	{ $current=$iv_ruleLhsVarRef.current; }
	EOF;

// Rule LhsVarRef
ruleLhsVarRef returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleInvariantClauseRule returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getInvariantClauseRuleRule()); }
	iv_ruleInvariantClauseRule=ruleInvariantClauseRule
	{ $current=$iv_ruleInvariantClauseRule.current; }
	EOF;

// Rule InvariantClauseRule
ruleInvariantClauseRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_E12Rule_8.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		{
			$current = $this_EnumRef_2.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_TupleExpr_3.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_IfPrimaryExpr_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ParenthesisExpr_5.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		{
			$current = $this_SynonymTypeRule_5.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleSynonymTypeRule returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSynonymTypeRuleRule()); }
	iv_ruleSynonymTypeRule=ruleSynonymTypeRule
	{ $current=$iv_ruleSynonymTypeRule.current; }
	EOF;

// Rule SynonymTypeRule
ruleSynonymTypeRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleIdTypeListRule returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getIdTypeListRuleRule()); }
	iv_ruleIdTypeListRule=ruleIdTypeListRule
	{ $current=$iv_ruleIdTypeListRule.current; }
	EOF;

// Rule IdTypeListRule
ruleIdTypeListRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
